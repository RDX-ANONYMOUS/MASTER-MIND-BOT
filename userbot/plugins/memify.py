...
async def _(event):
    ...
    if reply_message.sender.bot:
     ...
     await event.edit("```Transfiguration Time! Mwahaha memifying this image! ```")
    ...
    async with borg.conversation("@MemeAutobot") as bot_conv:
          ...
          if "Okay..." in response.text:
            await event.edit("```🤨 JANI?! This is not an image! This will take sum tym to convert to image owo 🧐```")
            thumb = None
